...
async function verifyToken(token) {
      try {
        ...
        // The payload contains the user's profile information
        console.log('User ID:', payload.sub);
        console.log('User Email:', payload.email);
        return payload; // You can return the payload for further use
      } catch (error) {
...
function ensureOAuthTokenInEnv(req) {
